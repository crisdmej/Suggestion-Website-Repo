 ...
 public partial class Profile
 {
     ...
     protected async override Task OnInitializedAsync()
     {
         ...
         if (loggedInUser is not null && results is not null)
         {
             ...
             approved = submissions.Where(s => s.ApprovedForRelease && s.Archive == false && s.Rejected == false).ToList();
             archived = submissions.Where(s => s.Archive && s.Rejected == false).ToList();
